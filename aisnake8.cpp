...
Status possta;//��ǰ��״̬
int lenth, tailnum, hasget, circle; //�ߵ�ǰ�ĳ��ȣ�β���ڵ�ǰ״̬�����е��±�
St pre;//����ѷ����ߵĵ�һ��
struct Point tail;//��ǰβ�͵�����
...
//��һ���Ƿ�����Ȧ��Χ��
	int Shrink_count = player->round / circle;//��Ȧ������
...
void init(struct Player *player) {//��ʼȫ�ֱ���
	lenth = 1;
	possta.head = -1;
	tailnum = -1;
...
struct Point walk(struct Player *player) {
	...
	if (pre.x != -1 && pre.y != -1) {
		...
		if (player->mat[pre.x][pre.y] == 'o'
		        ...
		        && player->round < 3 * (player->col_cnt + player->row_cnt) / 8 + 1) //����ڻ��������غ���Ե����ߣ���¼�Ե��ĸ���
			hasget++;
